...
(describe "world-resize"
  ...
  (it "regenerates the four-row waterline art to span the new width" (let ((world (tiny-world :width 40 :height 20))) (world-resize world 15 20) (let ((waterline (find :waterline (cl-asciiquarium::world-%creatures world) :key #'creature-kind))) (multiple-value-bind (width height) (sprite-dimensions (creature-art waterline)) (expect width :to-be 15) (expect height :to-be 4)))))
